...
`;var Select_SelectStyle=styled_components_browser_esm.cp.select`
  ...
  ${({error:error})=>error&&styled_components_browser_esm.gV`
    ...
    `}
`,__rest=function(s,e){var t={};for(var p in s)Object.prototype.hasOwnProperty.call(s,p)&&e.indexOf(p)<0&&(t[p]=s[p]);if(null!=s&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(p=Object.getOwnPropertySymbols(s);i<p.length;i++)e.indexOf(p[i])<0&&Object.prototype.propertyIsEnumerable.call(s,p[i])&&(t[p[i]]=s[p[i]])}return t};var Select_Select=(0,react.forwardRef)(((_a,externalRef)=>{var{id:id,value:value,label:label,srOnly:srOnlyProp,error:error,labelStyle:labelStyle,onChange:onChange,children:children,disabled:disabled,className:className}=_a,otherProps=__rest(_a,["id","value","label","srOnly","error","labelStyle","onChange","children","disabled","className"]);const srOnly=srOnlyProp||!1,[selectedValue,setSelectedValue]=(0,react.useState)(""),ref=(0,react.useRef)(null),updateValue=(0,react.useCallback)((select=>{const selectedOption=function getSelectedOptions(select){return select.selectedOptions?Array.from(select.selectedOptions):Array.from(select.querySelectorAll(":checked"))}(select)[0];(null==selectedOption?void 0:selectedOption.textContent)&&setSelectedValue(selectedOption.textContent)}),[]),handleChange=(0,react.useCallback)((event=>{updateValue(event.target),onChange&&onChange(event)}),[onChange,updateValue]);return(0,react.useImperativeHandle)(externalRef,(()=>ref.current)),(0,react.useEffect)((()=>{ref.current&&updateValue(ref.current)}),[ref,updateValue,value]),(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[label&&(0,jsx_runtime.jsx)(FormLabelStyle_FormLabelStyle,Object.assign({srOnly:srOnly,htmlFor:id,label:label,style:labelStyle},{children:label})),(0,jsx_runtime.jsxs)(SelectWrapper,Object.assign({className:className},{children:[(0,jsx_runtime.jsx)(Select_SelectStyle,Object.assign({},Object.assign(Object.assign({},otherProps),{id:id,value:value,error:error}),{disabled:disabled,error:error,ref:ref,onChange:handleChange},{children:children})),(0,jsx_runtime.jsxs)(AbsoluteContentWrapper,{children:[(0,jsx_runtime.jsx)(SelectedValue,Object.assign({"data-testid":"selectedValue",disabled:disabled},{children:selectedValue})),(0,jsx_runtime.jsx)(SelectIcon,{})]})]}))]})}))},"./node_modules/@amsterdam/asc-ui/es/components/shared/constants.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Ku:function(){return INPUT_SIZE}});const INPUT_SIZE=44},"./node_modules/@amsterdam/asc-ui/es/utils/hooks/usePassPropsToChildren.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");__webpack_exports__.c=(childrenProps,propsOrCallback)=>({children:react__WEBPACK_IMPORTED_MODULE_0__.Children.map(childrenProps,((child,index)=>(0,react__WEBPACK_IMPORTED_MODULE_0__.cloneElement)(child,"function"==typeof propsOrCallback?propsOrCallback(index):propsOrCallback)))})},"./src/components/final-form/SelectField/SelectField.stories.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{WithError:function(){return WithError},WithHint:function(){return WithHint},WithLabel:function(){return WithLabel},WithRequired:function(){return WithRequired},WithoutLabel:function(){return WithoutLabel},__namedExportsOrder:function(){return __namedExportsOrder}});__webpack_require__("./node_modules/react/index.js");var _SelectField__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/final-form/SelectField/SelectField.tsx"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/react/jsx-runtime.js");__webpack_exports__.default={title:"SelectField"};const WithLabel=()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_SelectField__WEBPACK_IMPORTED_MODULE_1__.Y,{name:"myFieldName",label:"foo",options:{"":"-",foo:"Foo",bar:"Bar"}});WithLabel.displayName="WithLabel";const WithHint=()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_SelectField__WEBPACK_IMPORTED_MODULE_1__.Y,{name:"myFieldName",label:"foo",hint:"Nullam quis risus eget urna mollis ornare vel eu leo.",options:{"":"-",foo:"Foo",bar:"Bar"}});WithHint.displayName="WithHint";const WithoutLabel=()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_SelectField__WEBPACK_IMPORTED_MODULE_1__.Y,{name:"myFieldName",options:{foo:"Foo",bar:"Bar"}});WithoutLabel.displayName="WithoutLabel";const WithError=()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_SelectField__WEBPACK_IMPORTED_MODULE_1__.Y,{name:"myFieldName",options:{foo:"Foo",bar:"Bar"},validate:()=>"Some error occurred"});WithError.displayName="WithError";const WithRequired=()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_SelectField__WEBPACK_IMPORTED_MODULE_1__.Y,{name:"myFieldName",options:{"":"-",foo:"Foo",bar:"Bar"},isRequired:!0});WithRequired.displayName="WithRequired",WithLabel.parameters={...WithLabel.parameters,docs:{...WithLabel.parameters?.docs,source:{originalSource:'() => <SelectField name=\'myFieldName\' label=\'foo\' options={{\n  "": "-",\n  foo: "Foo",\n  bar: "Bar"\n}} />',...WithLabel.parameters?.docs?.source}}},WithHint.parameters={...WithHint.parameters,docs:{...WithHint.parameters?.docs,source:{originalSource:'() => <SelectField name=\'myFieldName\' label=\'foo\' hint=\'Nullam quis risus eget urna mollis ornare vel eu leo.\' options={{\n  "": "-",\n  foo: "Foo",\n  bar: "Bar"\n}} />',...WithHint.parameters?.docs?.source}}},WithoutLabel.parameters={...WithoutLabel.parameters,docs:{...WithoutLabel.parameters?.docs,source:{originalSource:'() => <SelectField name=\'myFieldName\' options={{\n  foo: "Foo",\n  bar: "Bar"\n}} />',...WithoutLabel.parameters?.docs?.source}}},WithError.parameters={...WithError.parameters,docs:{...WithError.parameters?.docs,source:{originalSource:'() => <SelectField name=\'myFieldName\' options={{\n  foo: "Foo",\n  bar: "Bar"\n}} validate={() => "Some error occurred"} />',...WithError.parameters?.docs?.source}}},WithRequired.parameters={...WithRequired.parameters,docs:{...WithRequired.parameters?.docs,source:{originalSource:'() => <SelectField name=\'myFieldName\' options={{\n  "": "-",\n  foo: "Foo",\n  bar: "Bar"\n}} isRequired={true} />',...WithRequired.parameters?.docs?.source}}};const __namedExportsOrder=["WithLabel","WithHint","WithoutLabel","WithError","WithRequired"]},"./src/components/final-form/SelectField/SelectField.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Y:function(){return SelectField}});__webpack_require__("./node_modules/react/index.js");var _unbound_UnboundSelectField__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/unbound/UnboundSelectField.tsx"),react_final_form__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/react-final-form/dist/react-final-form.es.js"),_validators_composeValidation__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__("./src/validators/composeValidation.ts"),_validators_isRequired__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__("./src/validators/isRequired.ts"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("./node_modules/react/jsx-runtime.js");const SelectField=_ref=>{let{name:name,validate:validate,isRequired:isRequired,...restProps}=_ref;const{input:input,meta:meta}=(0,react_final_form__WEBPACK_IMPORTED_MODULE_2__.m4)(name,{type:"select",validate:(0,_validators_composeValidation__WEBPACK_IMPORTED_MODULE_4__.u)([isRequired&&(0,_validators_isRequired__WEBPACK_IMPORTED_MODULE_5__.U)(),validate])});return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_unbound_UnboundSelectField__WEBPACK_IMPORTED_MODULE_1__.c,{error:meta.touched&&meta.error,...input,...restProps})};SelectField.displayName="SelectField",__webpack_exports__.c=SelectField},"./src/components/layout/responsiveProps.ts":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Y:function(){return responsiveProps}});var _amsterdam_asc_ui__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@amsterdam/asc-ui/es/utils/themeUtils.js"),styled_components__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const breakPoints=["mobileS","mobileM","mobileL","tabletS","tabletM","laptop","laptopM","laptopL","desktop","desktopL"],responsiveProps=(props,map)=>{const nonResponsiveRules=Object.entries(map).filter((_ref=>{let[key]=_ref;return!(obj=>{if("object"!=typeof obj)return!1;const keys=Object.keys(obj);for(const breakPoint of breakPoints)if(keys.includes(breakPoint))return!0;return!1})(props[key])})).map((_ref2=>{let[key,fun]=_ref2;return fun(props[key])}));return[breakPoints.map((bp=>{const responsiveCssRules=Object.entries(map).filter((_ref3=>{let[key]=_ref3;return void 0!==props?.[key]?.[bp]})).map((_ref4=>{let[key,fun]=_ref4;return fun(props[key][bp])}));return responsiveCssRules.length>0?(bk=bp,cssRules=responsiveCssRules,styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
