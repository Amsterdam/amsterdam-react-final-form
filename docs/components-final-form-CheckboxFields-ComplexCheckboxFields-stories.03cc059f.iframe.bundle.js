...
`;LabelStyle.defaultProps={position:"right",align:"center"};const LabelTextStyle=styled_components__WEBPACK_IMPORTED_MODULE_0__.cp.span`
  ...
  ${({position:position})=>"top"===position||"left"===position?styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
        ...
        `:styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
          order: 1;
        `}
`;__webpack_exports__.c=LabelStyle},"./node_modules/@amsterdam/asc-ui/es/utils/hooks/usePassPropsToChildren.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");__webpack_exports__.c=(childrenProps,propsOrCallback)=>({children:react__WEBPACK_IMPORTED_MODULE_0__.Children.map(childrenProps,((child,index)=>(0,react__WEBPACK_IMPORTED_MODULE_0__.cloneElement)(child,"function"==typeof propsOrCallback?propsOrCallback(index):propsOrCallback)))})},"./src/components/final-form/CheckboxFields/ComplexCheckboxFields.stories.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{WithError:function(){return WithError},WithLabel:function(){return WithLabel},WithRequired:function(){return WithRequired},WithoutLabel:function(){return WithoutLabel},__namedExportsOrder:function(){return __namedExportsOrder}});var _ComplexCheckboxFields__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/components/final-form/CheckboxFields/ComplexCheckboxFields.tsx"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react/jsx-runtime.js");__webpack_exports__.default={title:"CheckboxFields/Complex data structure",component:_ComplexCheckboxFields__WEBPACK_IMPORTED_MODULE_0__.c};const StoryComponent=args=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_ComplexCheckboxFields__WEBPACK_IMPORTED_MODULE_0__.c,{...args});StoryComponent.displayName="StoryComponent";const WithLabel=StoryComponent.bind({});WithLabel.args={name:"myFieldName",label:"foo",optionLabelField:"myLabel",options:[{myLabel:"My Label 1",myValue:1,something:{nested:{foo:!0}}},{myLabel:"My Label 2",myValue:2,something:{nested:{foo:!1}}}]};const WithoutLabel=StoryComponent.bind({});WithoutLabel.args={...WithLabel.args,label:void 0};const WithError=StoryComponent.bind({});WithError.args={...WithLabel.args,validate:()=>"Some error occurred"};const WithRequired=StoryComponent.bind({});WithRequired.args={...WithLabel.args,isRequired:!0},WithLabel.parameters={...WithLabel.parameters,docs:{...WithLabel.parameters?.docs,source:{originalSource:"args => <ComplexCheckboxFields {...args} />",...WithLabel.parameters?.docs?.source}}},WithoutLabel.parameters={...WithoutLabel.parameters,docs:{...WithoutLabel.parameters?.docs,source:{originalSource:"args => <ComplexCheckboxFields {...args} />",...WithoutLabel.parameters?.docs?.source}}},WithError.parameters={...WithError.parameters,docs:{...WithError.parameters?.docs,source:{originalSource:"args => <ComplexCheckboxFields {...args} />",...WithError.parameters?.docs?.source}}},WithRequired.parameters={...WithRequired.parameters,docs:{...WithRequired.parameters?.docs,source:{originalSource:"args => <ComplexCheckboxFields {...args} />",...WithRequired.parameters?.docs?.source}}};const __namedExportsOrder=["WithLabel","WithoutLabel","WithError","WithRequired"]},"./src/components/final-form/CheckboxFields/ComplexCheckboxFields.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),react_final_form__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react-final-form/dist/react-final-form.es.js"),_utils_findIndex__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./src/utils/findIndex.ts"),_unbound_UnboundCheckboxes__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("./src/components/unbound/UnboundCheckboxes.tsx"),_validators_composeValidation__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__("./src/validators/composeValidation.ts"),_validators_isRequired__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__("./src/validators/isRequired.ts"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__("./node_modules/react/jsx-runtime.js");function ComplexCheckboxFields(_ref){let{name:name,options:options,optionLabelField:optionLabelField,validate:validate,isRequired:isRequired,...restProps}=_ref;const{input:{onChange:onChange,value:value},meta:meta}=(0,react_final_form__WEBPACK_IMPORTED_MODULE_1__.m4)(name,{validate:(0,_validators_composeValidation__WEBPACK_IMPORTED_MODULE_5__.u)([isRequired&&(0,_validators_isRequired__WEBPACK_IMPORTED_MODULE_6__.U)(),validate])}),mappedOptions=options.reduce(((acc,option,index)=>({...acc,[index]:option[optionLabelField]})),{}),handleChange=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((indexes=>{const mappedBack=indexes.map((index=>options[parseInt(index)]));onChange(mappedBack)}),[onChange,options]);return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_unbound_UnboundCheckboxes__WEBPACK_IMPORTED_MODULE_3__.m,{error:meta.dirty&&meta.error,options:mappedOptions,onChange:handleChange,values:(0,_utils_findIndex__WEBPACK_IMPORTED_MODULE_2__.y)(options,value).map((_=>_.toString())),...restProps})}ComplexCheckboxFields.displayName="ComplexCheckboxFields",__webpack_exports__.c=ComplexCheckboxFields},"./src/components/layout/responsiveProps.ts":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,{Y:function(){return responsiveProps}});var _amsterdam_asc_ui__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@amsterdam/asc-ui/es/utils/themeUtils.js"),styled_components__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const breakPoints=["mobileS","mobileM","mobileL","tabletS","tabletM","laptop","laptopM","laptopL","desktop","desktopL"],responsiveProps=(props,map)=>{const nonResponsiveRules=Object.entries(map).filter((_ref=>{let[key]=_ref;return!(obj=>{if("object"!=typeof obj)return!1;const keys=Object.keys(obj);for(const breakPoint of breakPoints)if(keys.includes(breakPoint))return!0;return!1})(props[key])})).map((_ref2=>{let[key,fun]=_ref2;return fun(props[key])}));return[breakPoints.map((bp=>{const responsiveCssRules=Object.entries(map).filter((_ref3=>{let[key]=_ref3;return void 0!==props?.[key]?.[bp]})).map((_ref4=>{let[key,fun]=_ref4;return fun(props[key][bp])}));return responsiveCssRules.length>0?(bk=bp,cssRules=responsiveCssRules,styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
