...
`;LabelStyle.defaultProps={position:"right",align:"center"};const LabelTextStyle=styled_components__WEBPACK_IMPORTED_MODULE_0__.cp.span`
  ...
  ${({position:position})=>"top"===position||"left"===position?styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
        ...
        `:styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
          order: 1;
        `}
`;__webpack_exports__.c=LabelStyle},"./node_modules/@amsterdam/asc-ui/es/utils/hooks/usePassPropsToChildren.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");__webpack_exports__.c=(childrenProps,propsOrCallback)=>({children:react__WEBPACK_IMPORTED_MODULE_0__.Children.map(childrenProps,((child,index)=>(0,react__WEBPACK_IMPORTED_MODULE_0__.cloneElement)(child,"function"==typeof propsOrCallback?propsOrCallback(index):propsOrCallback)))})},"./src/components/final-form/BooleanField/BooleanField.stories.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{CheckboxLabel:function(){return CheckboxLabel},WithError:function(){return WithError},WithHint:function(){return WithHint},WithLabel:function(){return WithLabel},WithRequired:function(){return WithRequired},__namedExportsOrder:function(){return __namedExportsOrder}});var _BooleanField__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/components/final-form/BooleanField/BooleanField.tsx"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react/jsx-runtime.js");__webpack_exports__.default={title:"BooleanField",component:_BooleanField__WEBPACK_IMPORTED_MODULE_0__.c};const StoryComponent=args=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_BooleanField__WEBPACK_IMPORTED_MODULE_0__.c,{...args});StoryComponent.displayName="StoryComponent";const WithLabel=StoryComponent.bind({});WithLabel.args={name:"myFieldName",label:"foo"};const WithHint=StoryComponent.bind({});WithHint.args={...WithLabel.args,hint:"Nullam quis risus eget urna mollis ornare vel eu leo.",checkboxLabel:"Specific checkbox label"};const CheckboxLabel=StoryComponent.bind({});CheckboxLabel.args={...WithLabel.args,checkboxLabel:"Specific checkbox label"};const WithError=StoryComponent.bind({});WithError.args={...WithLabel.args,validate:()=>"Some error occurred"};const WithRequired=StoryComponent.bind({});WithRequired.args={...WithLabel.args,isRequired:!0},WithLabel.parameters={...WithLabel.parameters,docs:{...WithLabel.parameters?.docs,source:{originalSource:"args => <BooleanField {...args} />",...WithLabel.parameters?.docs?.source}}},WithHint.parameters={...WithHint.parameters,docs:{...WithHint.parameters?.docs,source:{originalSource:"args => <BooleanField {...args} />",...WithHint.parameters?.docs?.source}}},CheckboxLabel.parameters={...CheckboxLabel.parameters,docs:{...CheckboxLabel.parameters?.docs,source:{originalSource:"args => <BooleanField {...args} />",...CheckboxLabel.parameters?.docs?.source}}},WithError.parameters={...WithError.parameters,docs:{...WithError.parameters?.docs,source:{originalSource:"args => <BooleanField {...args} />",...WithError.parameters?.docs?.source}}},WithRequired.parameters={...WithRequired.parameters,docs:{...WithRequired.parameters?.docs,source:{originalSource:"args => <BooleanField {...args} />",...WithRequired.parameters?.docs?.source}}};const __namedExportsOrder=["WithLabel","WithHint","CheckboxLabel","WithError","WithRequired"]},"./src/components/final-form/BooleanField/BooleanField.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{c:function(){return BooleanField_BooleanField}});__webpack_require__("./node_modules/react/index.js");var react_final_form_es=__webpack_require__("./node_modules/react-final-form/dist/react-final-form.es.js"),Label=__webpack_require__("./node_modules/@amsterdam/asc-ui/es/components/Label/Label.js"),Checkbox=__webpack_require__("./node_modules/@amsterdam/asc-ui/es/components/Checkbox/Checkbox.js"),ComposedField=__webpack_require__("./src/components/unbound/ComposedField.tsx"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const UnboundBooleanField=_ref=>{let{label:label,extraLabel:extraLabel,extraLabelAlign:extraLabelAlign,hint:hint,error:error,position:position,align:align,tooltip:tooltip,checkboxLabel:checkboxLabel="",...otherProps}=_ref;return(0,jsx_runtime.jsx)(ComposedField.c,{id:otherProps.id??otherProps.name,label:label,extraLabel:extraLabel,extraLabelAlign:extraLabelAlign,hint:hint,error:error,position:position,align:align,tooltip:tooltip,children:(0,jsx_runtime.jsx)(Label.c,{label:checkboxLabel,children:(0,jsx_runtime.jsx)(Checkbox.c,{id:otherProps.id??otherProps.name,"data-testid":otherProps.id??otherProps.name,error:!!error,...otherProps})})})};UnboundBooleanField.displayName="UnboundBooleanField";var unbound_UnboundBooleanField=UnboundBooleanField,composeValidation=__webpack_require__("./src/validators/composeValidation.ts");const isNotFalsy=function(){let message=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"Dit veld is verplicht";return value=>{if(!value)return message}},BooleanField=_ref=>{let{name:name,validate:validate,isRequired:isRequired,...restProps}=_ref;const{input:input,meta:meta}=(0,react_final_form_es.m4)(name,{type:"checkbox",validate:(0,composeValidation.u)([isRequired&&isNotFalsy(),validate])});return(0,jsx_runtime.jsx)(unbound_UnboundBooleanField,{error:meta.dirty&&meta.error,...input,...restProps})};BooleanField.displayName="BooleanField";var BooleanField_BooleanField=BooleanField},"./src/components/layout/responsiveProps.ts":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Y:function(){return responsiveProps}});var _amsterdam_asc_ui__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@amsterdam/asc-ui/es/utils/themeUtils.js"),styled_components__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const breakPoints=["mobileS","mobileM","mobileL","tabletS","tabletM","laptop","laptopM","laptopL","desktop","desktopL"],responsiveProps=(props,map)=>{const nonResponsiveRules=Object.entries(map).filter((_ref=>{let[key]=_ref;return!(obj=>{if("object"!=typeof obj)return!1;const keys=Object.keys(obj);for(const breakPoint of breakPoints)if(keys.includes(breakPoint))return!0;return!1})(props[key])})).map((_ref2=>{let[key,fun]=_ref2;return fun(props[key])}));return[breakPoints.map((bp=>{const responsiveCssRules=Object.entries(map).filter((_ref3=>{let[key]=_ref3;return void 0!==props?.[key]?.[bp]})).map((_ref4=>{let[key,fun]=_ref4;return fun(props[key][bp])}));return responsiveCssRules.length>0?(bk=bp,cssRules=responsiveCssRules,styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
