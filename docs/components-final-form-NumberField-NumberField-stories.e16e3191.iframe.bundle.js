...
`;LabelStyle.defaultProps={position:"right",align:"center"};const LabelTextStyle=styled_components__WEBPACK_IMPORTED_MODULE_0__.cp.span`
  ...
  ${({position:position})=>"top"===position||"left"===position?styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
        ...
        `:styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
          order: 1;
        `}
`;__webpack_exports__.c=LabelStyle},"./node_modules/@amsterdam/asc-ui/es/components/shared/constants.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Ku:function(){return INPUT_SIZE}});const INPUT_SIZE=44},"./node_modules/@amsterdam/asc-ui/es/utils/hooks/usePassPropsToChildren.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");__webpack_exports__.c=(childrenProps,propsOrCallback)=>({children:react__WEBPACK_IMPORTED_MODULE_0__.Children.map(childrenProps,((child,index)=>(0,react__WEBPACK_IMPORTED_MODULE_0__.cloneElement)(child,"function"==typeof propsOrCallback?propsOrCallback(index):propsOrCallback)))})},"./src/components/final-form/NumberField/NumberField.stories.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{WithDisabled:function(){return WithDisabled},WithError:function(){return WithError},WithExtraLabel:function(){return WithExtraLabel},WithHint:function(){return WithHint},WithLabel:function(){return WithLabel},WithMinMax:function(){return WithMinMax},WithRequired:function(){return WithRequired},WithoutLabel:function(){return WithoutLabel},WithoutNumberSpinner:function(){return WithoutNumberSpinner},__namedExportsOrder:function(){return __namedExportsOrder}});var _NumberField__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/components/final-form/NumberField/NumberField.tsx"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react/jsx-runtime.js");__webpack_exports__.default={title:"NumberField",component:_NumberField__WEBPACK_IMPORTED_MODULE_0__.c};const StoryComponent=args=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_NumberField__WEBPACK_IMPORTED_MODULE_0__.c,{...args});StoryComponent.displayName="StoryComponent";const WithLabel=StoryComponent.bind({});WithLabel.args={name:"myFieldName",label:"foo"};const WithExtraLabel=StoryComponent.bind({});WithExtraLabel.args={...WithLabel.args,extraLabel:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("strong",{children:"foo"})};const WithHint=StoryComponent.bind({});WithHint.args={...WithLabel.args,hint:"Nullam quis risus eget urna mollis ornare vel eu leo."};const WithoutLabel=StoryComponent.bind({});WithoutLabel.args={...WithLabel.args,label:void 0};const WithError=StoryComponent.bind({});WithError.args={...WithLabel.args,validate:()=>"some error occurred"};const WithRequired=StoryComponent.bind({});WithRequired.args={...WithLabel.args,required:!0};const WithDisabled=StoryComponent.bind({});WithDisabled.args={...WithLabel.args,required:!0,disabled:!0};const WithoutNumberSpinner=StoryComponent.bind({});WithoutNumberSpinner.args={...WithLabel.args,hideNumberSpinner:!0};const WithMinMax=StoryComponent.bind({});WithMinMax.args={...WithLabel.args,min:0,max:20},WithLabel.parameters={...WithLabel.parameters,docs:{...WithLabel.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithLabel.parameters?.docs?.source}}},WithExtraLabel.parameters={...WithExtraLabel.parameters,docs:{...WithExtraLabel.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithExtraLabel.parameters?.docs?.source}}},WithHint.parameters={...WithHint.parameters,docs:{...WithHint.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithHint.parameters?.docs?.source}}},WithoutLabel.parameters={...WithoutLabel.parameters,docs:{...WithoutLabel.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithoutLabel.parameters?.docs?.source}}},WithError.parameters={...WithError.parameters,docs:{...WithError.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithError.parameters?.docs?.source}}},WithRequired.parameters={...WithRequired.parameters,docs:{...WithRequired.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithRequired.parameters?.docs?.source}}},WithDisabled.parameters={...WithDisabled.parameters,docs:{...WithDisabled.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithDisabled.parameters?.docs?.source}}},WithoutNumberSpinner.parameters={...WithoutNumberSpinner.parameters,docs:{...WithoutNumberSpinner.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithoutNumberSpinner.parameters?.docs?.source}}},WithMinMax.parameters={...WithMinMax.parameters,docs:{...WithMinMax.parameters?.docs,source:{originalSource:"args => <NumberField {...args} />",...WithMinMax.parameters?.docs?.source}}};const __namedExportsOrder=["WithLabel","WithExtraLabel","WithHint","WithoutLabel","WithError","WithRequired","WithDisabled","WithoutNumberSpinner","WithMinMax"]},"./src/components/final-form/NumberField/NumberField.tsx":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{c:function(){return NumberField_NumberField}});__webpack_require__("./node_modules/react/index.js");var react_final_form_es=__webpack_require__("./node_modules/react-final-form/dist/react-final-form.es.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");__webpack_require__("./node_modules/final-form/dist/final-form.es.js");const isAbove=function(min){let message=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"De waarde moet hoger dan {min} zijn";return value=>{if(null==value)return;const parsedMin="string"==typeof min?parseFloat(min):min;return("string"==typeof value?parseFloat(value):value)<parsedMin?message.replace("{min}",min.toString()).replace("{value}",value.toString()):void 0}},isBelow=function(max){let message=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"De waarde moet lager dan {max} zijn";return value=>{if(null==value)return;const parsedMax="string"==typeof max?parseFloat(max):max;return("string"==typeof value?parseFloat(value):value)>parsedMax?message.replace("{max}",max.toString()).replace("{value}",value.toString()):void 0}};var composeValidation=__webpack_require__("./src/validators/composeValidation.ts"),validators_isRequired=__webpack_require__("./src/validators/isRequired.ts"),UnboundTextField=__webpack_require__("./src/components/unbound/UnboundTextField.tsx"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const StyledUnboundTextField=(0,styled_components_browser_esm.cp)(UnboundTextField.c)`
   ${props=>props.hideNumberSpinner&&"\n      &::-webkit-inner-spin-button,\n      &::-webkit-outer-spin-button {\n        -webkit-appearance: none;\n        margin: 0;\n      }\n   "}   
`,NumberField=_ref=>{let{name:name,label:label,validate:validate,isRequired:isRequired,...otherProps}=_ref;const{meta:meta,input:input}=(0,react_final_form_es.m4)(name,{type:"number",parse:val=>{const parsed=parseFloat(val);return isNaN(parsed)?null:parsed},validate:(0,composeValidation.u)([isRequired&&(0,validators_isRequired.U)(),void 0!==otherProps.min&&isAbove(otherProps.min),void 0!==otherProps.max&&isBelow(otherProps.max),validate])});return(0,jsx_runtime.jsx)(StyledUnboundTextField,{label:label,error:meta.touched&&meta.error,...input,...otherProps})};NumberField.displayName="NumberField";var NumberField_NumberField=NumberField},"./src/components/layout/responsiveProps.ts":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Y:function(){return responsiveProps}});var _amsterdam_asc_ui__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@amsterdam/asc-ui/es/utils/themeUtils.js"),styled_components__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const breakPoints=["mobileS","mobileM","mobileL","tabletS","tabletM","laptop","laptopM","laptopL","desktop","desktopL"],responsiveProps=(props,map)=>{const nonResponsiveRules=Object.entries(map).filter((_ref=>{let[key]=_ref;return!(obj=>{if("object"!=typeof obj)return!1;const keys=Object.keys(obj);for(const breakPoint of breakPoints)if(keys.includes(breakPoint))return!0;return!1})(props[key])})).map((_ref2=>{let[key,fun]=_ref2;return fun(props[key])}));return[breakPoints.map((bp=>{const responsiveCssRules=Object.entries(map).filter((_ref3=>{let[key]=_ref3;return void 0!==props?.[key]?.[bp]})).map((_ref4=>{let[key,fun]=_ref4;return fun(props[key][bp])}));return responsiveCssRules.length>0?(bk=bp,cssRules=responsiveCssRules,styled_components__WEBPACK_IMPORTED_MODULE_0__.gV`
...
//# sourceMappingURL=components-final-form-NumberField-NumberField-stories.e16e3191.iframe.bundle.js.map